...
If you want to use "https://maps.helcom.fi/arcgis/rest/directories/arcgisoutput/MADS/tools_GPServer/_ags_HELCOM_subbasin_with_coastal_WFD_waterbodies_or_wa.zip" as input, you need to visit https://maps.helcom.fi/website/MADS/download/?id=67d653b1-aad1-4af4-920e-0683af3c4a48 and accept the data usage disclaimer.
...
`docker run -it -v ./in:/in -v ./out:/out -e R_SCRIPT="map_shapefile_points.R" daugava-workflow-image -- "https://maps.helcom.fi/arcgis/rest/directories/arcgisoutput/MADS/tools_GPServer/_ags_HELCOM_subbasin_with_coastal_WFD_waterbodies_or_wa.zip" "https://aquainfra.ogc.igb-berlin.de/download/out/data_merged_with_regions-adb1a066-e783-11ef-8e74-fa163e42fba0.csv" "longitude" "latitude" "transparency_m" "HELCOM_ID"  "/out/tmp7.html"`
